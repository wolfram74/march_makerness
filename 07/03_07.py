...
# test = solid.rotate_extrude(convexity = 10)(solid.circle(r=3))

# section = solid.intersection()(cone, plane)

#fake_me = solid.translate([-50,-10,0])(mannequin())
# circ = conic_section(0)
# elipse = solid.translate([0,10,0])(solid.rotate([0,0,-90])(conic_section(30)))
# parab = solid.translate([0,-10,0])(solid.rotate([0,0,90])(conic_section(45)))
# hyperb =solid.translate([-10,0,0])(conic_section(60))

circ = conic_section(0)
elipse = solid.translate([4,0,0])(conic_section(30))
parab = solid.translate([5,0,0])(conic_section(45))
hyperb = solid.translate([6.5,0,0])(conic_section(60))


object = [circ, elipse, parab, hyperb]
# for i in range(13):
# 	object += [solid.translate([0,10*i,3*i])(conic_section(i*10))]
