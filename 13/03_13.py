...
waterout = solid.translate([0,0,123])(waterout)
flows = waterin + waterout
flows = solid.color("Blue")(solid.translate([15,-2.5,0])(flows))



object = [trough, light, tube1, tube2, planters,flows]

rack = join_list(object)
rack = solid.translate([10,2.5,25])(solid.rotate([0,90,0])(rack))

strut1 = solid.translate([10,1.5,10])(solid.cube([2,1,12]))
strut2 = solid.translate([0,16,0])(strut1)
strut3 = solid.translate([121,0,0])(strut1)
strut4 = solid.translate([121,16,0])(strut1)
struts = solid.color("Silver")(join_list([strut1, strut2, strut3, strut4]))

row = join_list([rack, struts])

row1 = solid.rotate([0,-6,0])(solid.translate([143,20,0])(solid.rotate([0,0,180])((row))))

row2 = solid.translate([0,0,55])(solid.rotate([0,6,0])(row))

row34 = solid.translate([0,0,75])(row1+row2)
me = solid.translate([-50,-10,0])(mannequin())
object = [row1, row2, row34, me]
