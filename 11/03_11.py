...
guidance = solid.translate([16,12,4])(solid.rotate([0,180,0])(rasp_pi()))

toonl= 40
toon1 = solid.cylinder(r=4, h= toonl)
toon1 += solid.sphere(r=4)
toon1 += solid.translate([0,0,toonl])(solid.sphere(r=4))
toon1 = solid.rotate([0,90,0])(toon1)
toon2 = solid.translate([0,30,0])(toon1)
floats =solid.color("Gainsboro")( toon1+toon2)

strut1 = solid.translate([3,0,4])(solid.cube([2,30,1]))
strut2 = solid.translate([35,0,0])(strut1)
strut3 = solid.translate([19,0,0])(strut1)
struts = solid.color("Gray")(strut1+strut2+strut3)

pvc = solid.color("Black")(solid.cube([40,30,1]))
hatching = []
for i in range(3):
	hatching += [solid.translate([10*(i+1)-.5,0,0])(solid.color("Silver")(solid.cube([1,30,1.1])))]

for j in range(2):
	hatching += [solid.translate([0,10*(j+1)-.5,0])(solid.color("Silver")(solid.cube([40,1,1.1])))]
grid= join_list(hatching)
pvc+= grid
pvc = solid.translate([0,0,5])(pvc)

battery1 = solid.color("Red")(solid.cube([8,4,1]))
battery1 = solid.translate([6,4,4])(battery1)
battery2 = solid.translate([0,18,0])(battery1)

prop1 = solid.translate([3,10-.5,0])(solid.cube([2,1,4]))
prop1 += solid.translate([1,9-.5,-2])(solid.cube([4,3,2]))
prop2 = solid.translate([0,10,0])(prop1)
motive = solid.color("Blue")( prop1 + prop2)

object = [guidance, floats, struts, pvc, battery1, battery2, motive]
